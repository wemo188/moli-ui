...
'<div class="cm-field" style="margin-bottom:8px"><div class="cm-field-label">模型</div><div style="position:relative;"><input type="text" class="cm-field-input" id="cmImgModel" list="cmImgModelList" placeholder="选择或输入模型名" value="' + App.escAttr(cfg.imgModel||'gpt-image-1') + '" style="padding-right:30px;"><datalist id="cmImgModelList"><option value="gpt-image-1"><option value="dall-e-3"><option value="dall-e-2"><option value="gpt-image-2"><option value="stable-diffusion-xl-1024-v1-0"></datalist><svg viewBox="0 0 24 24" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);width:14px;height:14px;fill:none;stroke:#999;stroke-width:2;pointer-events:none;"><path d="M6 9l6 6 6-6"/></svg></div></div>' +
