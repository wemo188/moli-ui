...
(function() {
  ...
  var Character = {
    ...
    renderList: function() {
      ...
      panel.innerHTML =
        '<div class="cl-page' + (modeClass ? ' ' + modeClass : '') + '" id="clPageInner" style="flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:40px 16px 40px;background:#fff;">' +
