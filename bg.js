...
var DEFAULT_SVGS = {
  ...
  dockForum: '<svg viewBox="0 0 64 64" fill="none" width="40" height="40"><defs><clipPath id="em1clip"><circle cx="32" cy="32" r="18"/></clipPath></defs><circle cx="32" cy="32" r="18" stroke="#9ca3b0" stroke-width="2.2" fill="none"/><g clip-path="url(#em1clip)"><ellipse cx="32" cy="32" rx="7" ry="18" stroke="#9ca3b0" stroke-width="1.4" fill="none"/><path d="M14 26H50" stroke="#9ca3b0" stroke-width="1.2"/><path d="M16 38H48" stroke="#9ca3b0" stroke-width="1.2"/></g><ellipse cx="32" cy="32" rx="28" ry="10" stroke="#9ca3b0" stroke-width="1.8" fill="none" transform="rotate(-20 32 32)"/><circle cx="52" cy="20" r="3" fill="#9ca3b0" stroke="#9ca3b0" stroke-width="1.4"/></svg>'
};
