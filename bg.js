...
var DEFAULT_SVGS = {
  iconUser: '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="52" height="52" style="position:relative;z-index:2;"><mask id="userMask"><rect width="64" height="64" fill="white"/><path d="M32 44L22.4 34.8C19.6 32 19.6 27.6 22.4 24.8C25 22.2 29.2 22.2 31.2 25.2L32 26.4L32.8 25.2C34.8 22.2 39 22.2 41.6 24.8C44.4 27.6 44.4 32 41.6 34.8L32 44Z" fill="black"/></mask><circle cx="32" cy="32" r="22" stroke="#999" stroke-width="2.2" fill="#999" mask="url(#userMask)"/></svg>',
  iconArchive: '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="52" height="52" style="position:relative;z-index:2;"><mask id="archiveMask"><rect width="64" height="64" fill="white"/><path d="M21 22L23 26L28 26.2L25.5 28.6L26.5 32L24 30.2L21.5 32L22.5 28.6L20 26.2L24 26Z" fill="black"/><line x1="28" y1="24" x2="42" y2="24" stroke="black" stroke-width="1.8" stroke-linecap="round"/><line x1="28" y1="29" x2="40" y2="29" stroke="black" stroke-width="1.6" stroke-linecap="round"/><line x1="28" y1="34" x2="41" y2="34" stroke="black" stroke-width="1.6" stroke-linecap="round"/><line x1="20" y1="42" x2="44" y2="42" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-dasharray="3 2"/></mask><rect x="16" y="14" width="32" height="34" rx="3" stroke="#999" stroke-width="2" fill="#999" mask="url(#archiveMask)"/></svg>',
  iconTheme: '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="52" height="52" style="position:relative;z-index:2;"><mask id="themeMask"><rect width="64" height="64" fill="white"/><circle cx="20" cy="28" r="4.5" fill="black"/><circle cx="32" cy="20" r="4.5" fill="black"/><circle cx="44" cy="28" r="4.5" fill="black"/><circle cx="22" cy="40" r="4.5" fill="black"/></mask><path d="M32 12C21 12 12 21 12 32C12 43 21 52 32 52C33.8 52 35.2 50.6 35.2 48.8C35.2 48 34.9 47.3 34.4 46.7C33.9 46.1 33.6 45.3 33.6 44.5C33.6 42.7 35 41.3 36.8 41.3H40C46.6 41.3 52 35.9 52 29.3C52 19.8 42.4 12 32 12Z" stroke="#999" stroke-width="2" fill="#999" mask="url(#themeMask)"/><circle cx="20" cy="28" r="4" stroke="#999" stroke-width="1.6" fill="none"/><circle cx="32" cy="20" r="4" stroke="#999" stroke-width="1.6" fill="none"/><circle cx="44" cy="28" r="4" stroke="#999" stroke-width="1.6" fill="none"/><circle cx="22" cy="40" r="4" stroke="#999" stroke-width="1.6" fill="none"/></svg>',
  iconSettings: '<svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="52" height="52" style="position:relative;z-index:2;"><mask id="settingsMask"><rect width="64" height="64" fill="white"/><circle cx="32" cy="32" r="5.5" fill="black"/></mask><path d="M30 18H34L34.5 21.5C35.6 21.8 36.6 22.3 37.6 22.9L40.5 21L42.5 23L40.2 25.5C40.8 26.5 41.3 27.5 41.6 28.6L45 29V33L41.6 33.4C41.3 34.5 40.8 35.5 40.2 36.5L42.5 39L40.5 41L37.6 39.1C36.6 39.7 35.6 40.2 34.5 40.5L34 44H30L29.5 40.5C28.4 40.2 27.4 39.7 26.4 39.1L23.5 41L21.5 39L23.8 36.5C23.2 35.5 22.7 34.5 22.4 33.4L19 33V29L22.4 28.6C22.7 27.5 23.2 26.5 23.8 25.5L21.5 23L23.5 21L26.4 22.9C27.4 22.3 28.4 21.8 29.5 21.5L30 18Z" stroke="#999" stroke-width="1.8" stroke-linejoin="round" fill="#999" mask="url(#settingsMask)"/><circle cx="32" cy="32" r="5.5" stroke="#999" stroke-width="1.5" fill="none"/></svg>',
...
var DEF_ICON_CFG = { borderW: 0.5, shadow: 0, borderColor: '#ffffff', shadowColor: '#ffffff', iconColor: '#999999', iconBg: 'rgba(255,255,255,0.25)', blur: 12, opacity: 1, radius: 15, iconSize: 42 };
...
var Bg = {
    ...
    panel.innerHTML =
      ...
      '<div class="bf-scroll-body">' +
        ...
        '<div class="bf-controls" id="bfBgControls">' +
          ...
          '<div class="bf-ctrl-row"><span class="bf-ctrl-label">图标大小</span><input type="range" id="bfIconSize" min="24" max="60" step="1" value="' + (iconConfig.iconSize||42) + '"><span class="bf-ctrl-val" id="bfIconSizeVal">' + (iconConfig.iconSize||42) + 'px</span></div>' +
          '<div class="bf-divider"></div>' +
  ...
  openComponent: function() {
    ...
    panel.querySelector('#bfResetLayout').addEventListener('click', function() {
      App.LS.remove('wtCardPos'); App.LS.remove('appIconOffsets'); App.LS.remove('calTimeOffset');
      var calRow = App.$('#calTimeRow'); if(calRow) calRow.style.transform = '';
      ...
      var edenData = App.LS.get('edenCard'); if(edenData) { edenData.posX = 0; edenData.posY = 0; App.LS.set('edenCard', edenData); }
      var edenCard = App.$('#edenCard'); if(edenCard) edenCard.style.transform = '';
      App.showToast('布局已恢复');
    });
  },
  ...
  applyBg: function(data, pageIdx) {
    ...
    var svgCSS =
      ...
      '#appIconsRow > div > div:first-child svg[width],' +
      '#appIconsRow > div > div:first-child svg[height],' +
