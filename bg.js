...
var DEFAULT_SVGS = {
  ...
  iconSettings: '<svg viewBox="0 0 64 64" fill="none" width="56" height="56"><mask id="gm1"><rect width="64" height="64" fill="white"/><circle cx="32" cy="32" r="7" fill="black"/></mask><g transform="translate(0,4.5)"><path d="M30 10H34L35 14.5C36.5 14.9 37.9 15.5 39.2 16.3L43 13.5L46 16.5L43.2 20.2C44 21.5 44.6 22.9 45 24.4L49.5 25.5V29.5L45 30.6C44.6 32.1 44 33.5 43.2 34.8L46 38.5L43 41.5L39.2 38.7C37.9 39.5 36.5 40.1 35 40.5L34 45H30L29 40.5C27.5 40.1 26.1 39.5 24.8 38.7L21 41.5L18 38.5L20.8 34.8C20 33.5 19.4 32.1 19 30.6L14.5 29.5V25.5L19 24.4C19.4 22.9 20 21.5 20.8 20.2L18 16.5L21 13.5L24.8 16.3C26.1 15.5 27.5 14.9 29 14.5L30 10Z" stroke="#999" stroke-width="2.2" stroke-linejoin="round" fill="#999" mask="url(#gm1)"/><circle cx="32" cy="32" r="7" stroke="#999" stroke-width="1.8" fill="none"/></g></svg>',
