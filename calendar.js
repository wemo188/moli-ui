...
var Cal={
  ...
  updateCardSchedule:function(){
    ...
    var items=list.filter(function(item){return !item.type||item.type==='schedule';});
  ...
  initDrag:function(){
    ...
    card.addEventListener('touchstart',function(e){
      ...
      var t=e.touches[0];startX=t.clientX;startY=t.clientY;longPressed=false;moved=false;isDragging=false;
      timer=setTimeout(function(){
        longPressed=true;
        startOX=Cal._dragOffsetX;startOY=Cal._dragOffsetY;
    ...
    card.addEventListener('touchmove',function(e){
      ...
      e.preventDefault();
      e.stopPropagation();
      Cal._dragOffsetX=startOX+t.clientX-startX;
      Cal._dragOffsetY=startOY+t.clientY-startY;
      card.style.transform='translate('+Cal._dragOffsetX+'px,'+Cal._dragOffsetY+'px)';
    },{passive:false});
    card.addEventListener('touchend',function(){
      clearTimeout(timer);timer=null;
      card.style.opacity='';card.style.transition='';card.style.zIndex='10';
      if(longPressed&&moved){
        App.LS.set('wtCardPos',{x:Cal._dragOffsetX,y:Cal._dragOffsetY});
      }
      longPressed=false;moved=false;isDragging=false;
    });
  },
  ...
  startAutoRefresh:function(){
    ...
    Cal._refreshTimer=setInterval(function(){
