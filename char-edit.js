  ...
  var CharEdit = {
    ...
    open: function(charId, modeIdx) {
      ...
      createPanel.innerHTML =
        ...
        '<div style="flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:0 16px 40px;">'+
          '<div class="comic-card">'+
            ...
            /* ★ 重做的顶部区域：头像+名字更紧凑，三框线条连接 */
            '<div class="cc-header" style="padding:12px 20px 8px;">'+
              '<div class="cc-avatar-box" id="ccAvatarBox" style="width:56px;height:56px;flex-shrink:0;">'+av+'</div>'+
              '<div class="cc-name-area" style="flex:1;min-width:0;"><div class="cc-name-label" style="font-size:9px;">CHARACTER NAME</div><input type="text" class="cc-name-input" id="ccNameInput" placeholder="输入角色名..." value="'+v('name')+'" style="font-size:14px;padding:4px 0;"></div>'+
            '</div>'+
            ...
            /* ★ 三个文本框用连续线条连接成一体 */
            '<div class="cc-linked-sections">'+

              /* 角色档案 - 默认色 */
              '<div class="cc-section cc-linked-first"><div class="cc-section-head"><div class="cc-section-title blue">角色档案</div></div><div class="cc-section-body"><div class="cc-content-area"><button class="cc-expand-btn" data-field="profile" type="button"><svg viewBox="0 0 24 24"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg></button><textarea id="ccProfile" placeholder="">'+v('profile')+'</textarea></div></div></div>'+

              /* 连接线 */
              '<div class="cc-link-line"></div>'+

              /* 示例对话 - 黑色 */
              '<div class="cc-section cc-linked-mid cc-section-dark"><div class="cc-section-head"><div class="cc-section-title">示例对话</div></div><div class="cc-section-body"><div class="cc-dialogue-area"><button class="cc-expand-btn" data-field="dialogExamples" type="button"><svg viewBox="0 0 24 24"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg></button><textarea id="ccDialog">'+v('dialogExamples')+'</textarea></div></div></div>'+

              /* 连接线 */
              '<div class="cc-link-line"></div>'+

              /* 后置指令 - 蓝色 */
              '<div class="cc-section cc-linked-last cc-section-blue"><div class="cc-section-head"><div class="cc-section-title">后置指令</div></div><div class="cc-section-body"><div class="cc-content-area"><button class="cc-expand-btn" data-field="postInstruction" type="button"><svg viewBox="0 0 24 24"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg></button><textarea id="ccPost">'+v('postInstruction')+'</textarea></div></div></div>'+
      ...
      createPanel.querySelector('#ccAvatarBox').addEventListener('click', function(){
        var box = this;
        CharEdit._showAvatarSourceMenu(box);
      });
    ...
    _showAvatarSourceMenu: function(box) {
      ...
      menu.innerHTML =
        '<div style="background:rgba(255,255,255,0.92);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-radius:14px;padding:20px;width:260px;box-shadow:0 8px 30px rgba(0,0,0,0.15);display:flex;flex-direction:column;gap:10px;">' +
          '<div style="font-size:13px;font-weight:700;color:#333;text-align:center;letter-spacing:1px;margin-bottom:4px;">选择头像来源</div>' +
      ...
      menu.querySelector('#avFromUrl').addEventListener('click', function() {
        ...
        var previewBox = urlPanel.querySelector('#avUrlPreview');
