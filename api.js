    ...
    renderPage: function() {
      ...
      page.innerHTML =
        ...
        '<div class="api-scroll">' +
          ...
          '<div class="api-comic"><div class="api-comic-bar"></div><div class="api-comic-body">' +
            '<div class="api-section-title">连接配置</div>' +
            ...
            '<button class="api-save-btn" id="apiSaveBtn" type="button">保 存 配 置</button>' +
          '</div><div class="api-comic-bar-bot"></div></div>' +

          '<div class="api-comic"><div class="api-comic-bar"></div><div class="api-comic-body">' +
            '<div class="api-section-title api-blue">模型参数</div>' +
            ...
            '<button class="api-save-btn" id="apiSaveParamsBtn" type="button" style="background:#88abda;border-color:#88abda;box-shadow:4px 4px 0 #111;">保 存 参 数</button>' +
          '</div><div class="api-comic-bar-bot"></div></div>' +

          '<div class="api-comic"><div class="api-comic-bar"></div><div class="api-comic-body">' +
            '<div class="api-section-title">已保存配置</div>' +
