...
function buildFormatRules(charData,settings){
  ...
  return baseIdentity+'\n\n'+
    ...
    '4. 叙事节奏自然流畅，有张有弛。情节推进适度，不要仓促也不要拖沓。\n'+
    '5. 描写要有画面感和沉浸感。善用五感细节（视觉、听觉、触觉、嗅觉、味觉）。\n\n'+
    '【绝对禁止】\n'+
    '1. 不要使用网文模板、八股文句式。\n'+
    '2. 不要重复之前已经描写过的内容。\n'+
    '3. 不要使用英文引号 ""，必须使用 '+qp[0]+qp[1]+'。\n\n'+
    '【思维链行为与语言严格约束】\n'+
    '1. 你的所有内部思考（thinking/reasoning）必须使用中文！绝对不允许使用英文。\n'+
    '2. 严禁在思考过程中复述、背诵本提示词规则、场景设定或前情提要！不要做无效重复！\n'+
    '3. 你的思考内容只允许围绕三个点展开：分析当前局势、揣摩角色此时真实的心理活动、规划接下来的剧情走向、人物的下一步动作和要说的话。\n'+
