    ...
    container.innerHTML =
      '<div class="pz-card" id="pzCardInner">' +
        ...
        '<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width="170" height="170">' +
          ...
          '</defs>' +
          '<path d="M6 6H24V13C26 13 28 14.5 28 17C28 19.5 26 21 24 21V28H6V6Z" stroke-width="0.8" stroke-linejoin="round" fill="transparent"/>' +
          '<image id="pzImg0" clip-path="url(#pzk31)" x="6" y="6" width="22" height="22" href="" preserveAspectRatio="xMidYMid slice"/>' +
          '<path d="M24 6H42V28H24V21C26 21 28 19.5 28 17C28 14.5 26 13 24 13V6Z" stroke-width="0.8" stroke-linejoin="round" fill="transparent"/>' +
          '<image id="pzImg1" clip-path="url(#pzk32)" x="24" y="6" width="18" height="22" href="" preserveAspectRatio="xMidYMid slice"/>' +
          '<path d="M6 28H24V35C22 35 20 36.5 20 39C20 41.5 22 43 24 43V50H6V28Z" stroke-width="0.8" stroke-linejoin="round" fill="transparent"/>' +
          ...
          '<g transform="translate(5 4) rotate(8 33 39)">' +
            '<path d="M24 28H42V50H24V43C26 43 28 41.5 28 39C28 36.5 26 35 24 35V28Z" stroke-width="0.8" stroke-linejoin="round" stroke-dasharray="2 1.5" fill="transparent"/>' +
