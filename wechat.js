...
(function() {
  ...
  var Wechat = {
    ...
    render: function() {
      ...
      /* ★ 图标尺寸统一用 style 控制，比 CSS 优先级高 */
      var iconSize = 'width:32px;height:32px;';
