...
quote:'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10.5" stroke="rgba(255,255,255,.7)" stroke-width="1.8" fill="none"/><path d="M7 14C7 11.2 8.2 8.5 10.5 7.2L11.2 8.5C9 9.8 8.5 11.2 8.5 13H10.5V16H7V14Z" stroke="rgba(255,255,255,.7)" stroke-width="1.8" stroke-linejoin="round" fill="none"/><path d="M13 14C13 11.2 14.2 8.5 16.5 7.2L17.2 8.5C15 9.8 14.5 11.2 14.5 13H16.5V16H13V14Z" stroke="rgba(255,255,255,.7)" stroke-width="1.8" stroke-linejoin="round" fill="none"/></svg>',
