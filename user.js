  ...
  var User = {
    ...
    init: function() {
      ...
      if (!App.$('#userPanel')) {
        ...
        panel.id = 'userPanel';
        panel.className = 'up-user-panel-hidden';
      ...
      if (!App.$('#archivePanel')) {
        ...
        archive.className = 'archive-panel';
        archive.innerHTML =
          '<div class="archive-header">' +
            '<div id="archiveClose" class="archive-header-btn">' +
              '<svg viewBox="0 0 24 24" class="archive-header-svg"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"/><line x1="12" y1="2" x2="12" y2="12"/></svg>' +
            '</div>' +
            '<div class="archive-header-title">档案存储</div>' +
            '<div id="archiveAdd" class="archive-header-btn archive-header-add">+</div>' +
          '</div>' +
          '<div class="t2-wrap">' +
            '<div class="t2-inner">' +
          ...
          '<div class="archive-content">' +
            '<div id="archivePanelUser" class="archive-tab-panel archive-tab-active"></div>' +
            '<div id="archivePanelChar" class="archive-tab-panel archive-tab-right"></div>' +
          '</div>';
      ...
      App.archive = {
        ...
        open: function(tab) {
          ...
          panel.classList.add('archive-visible');
          App.archive.switchTab(tab || 'user');
          requestAnimationFrame(function() { requestAnimationFrame(function() {
            panel.classList.add('archive-in');
          }); });
        ...
        close: function() {
          var panel = App.$('#archivePanel');
          if (!panel) return;
          App.archive._isOpen = false;
          panel.classList.remove('archive-in');
          setTimeout(function() { panel.classList.remove('archive-visible'); }, 350);
        },
        switchTab: function(tab) {
          ...
          if (tab === 'user') {
            ...
            panelUser.className = 'archive-tab-panel archive-tab-active';
            panelChar.className = 'archive-tab-panel archive-tab-right';
            ...
            panelChar.className = 'archive-tab-panel archive-tab-active';
            panelUser.className = 'archive-tab-panel archive-tab-left';
