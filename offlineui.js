...
var DEF_AP={chatFont:'',bgBlur:0,bgDark:0,povOn:true,povUser:'second',povChar:'third',wordCount:0,pageBg:'#ffffff',barBg:'linear-gradient(135deg, #ffffff 0%, #e6f5ff 25%, #b9dcfa 55%, #dcf0ff 75%, #ffffff 100%)',barBgImg:'',barBorderColor:'rgba(255,255,255,0.9)',barBorderW:1,barRadius:0,barIconColor:'#adcdea',inputTextColor:'#adcdea',placeholder:'宇宙带着星轨在私奔✮ ࣪ ⊹⋆˚',cardBg:'#ffffff',cardTextColor:'#7ea3c9',cardT1:'',cardT2:'',cardT3:'',cardT4:'',cardFont:'',mode:'bubble',blockGap:20,cAvShow:true,cAvNameShow:true,cAvSize:70,cAvRadius:50,cAvFrameColor:'#9ca3af',cAvFrameW:2,cAvNameSize:18,cBubbleBg:'linear-gradient(135deg, #ffffff 0%, #edf1f5 40%, #e2e8f0 70%, #f4f7f9 100%)',cBubbleRadius:14,cBubbleBorderColor:'rgba(255,255,255,0.9)',cBubbleBorderW:0,cBubbleWidth:95,cBubbleOpacity:100,cBubbleBlur:0,cTextSize:16,cTextWeight:400,cTextLH:1.85,cTextColor:'#2e4258',cParaGap:8,cLetterGap:0,cQuoteOn:false,cQuoteRec:['curly','straight'],cQuoteDis:'curly',cQuoteColor:'#6b7280',cQuoteSize:16,cQuoteWeight:400,cQuoteItalic:true,cParenOn:false,cParenRec:['full','half'],cParenDis:'full',cParenHide:false,cParenColor:'#6b7280',cParenSize:16,cParenWeight:400,cParenItalic:true,cStarOn:false,cStarHide:true,cStarColor:'#6b7280',cStarSize:16,cStarWeight:400,cStarItalic:true,uAvShow:true,uAvNameShow:true,uAvSize:70,uAvRadius:50,uAvFrameColor:'#7ea3c9',uAvFrameW:2,uAvNameSize:18,uBubbleBg:'linear-gradient(135deg, #ffffff 0%, #f0f7fc 40%, #e0f0fa 70%, #f4f9fd 100%)',uBubbleRadius:14,uBubbleBorderColor:'rgba(255,255,255,0.9)',uBubbleBorderW:0,uBubbleWidth:95,uBubbleOpacity:100,uBubbleBlur:0,uTextSize:16,uTextWeight:400,uTextLH:1.85,uTextColor:'#2e4258',uParaGap:8,uLetterGap:0,quoteOn:false,quoteRec:['curly','straight'],quoteDis:'curly',quoteColor:'#7ea3c9',quoteSize:16,quoteWeight:400,quoteItalic:false,parenOn:false,parenRec:['full','half'],parenDis:'full',parenHide:false,parenColor:'#7ea3c9',parenSize:16,parenWeight:400,parenItalic:true,starOn:false,starHide:true,starColor:'#7ea3c9',starSize:16,starWeight:400,starItalic:true};
...
'</div>' +
'<div id="olSettingsPanel" class="half-panel hidden"><div class="hp-handle"></div><div class="hp-header"><button class="hp-close" id="olPanelClose" type="button"><svg viewBox="0 0 24 24"><path d="M18 6L6 18M6 6l12 12"/></svg></button></div><div class="hp-body"><div class="hp-upload" id="olSbScene"><svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>编辑场景/时间线</div><div class="hp-upload" id="olSbBg"><svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>上传背景</div><div class="hp-slider-row"><span class="hp-slider-label">白色遮罩</span><input type="range" id="olBgBlur" min="0" max="100" value="'+ap.bgBlur+'"><span class="hp-slider-val" id="olBgBlurVal">'+ap.bgBlur+'%</span></div><div class="hp-slider-row"><span class="hp-slider-label">暗度视觉</span><input type="range" id="olBgDark" min="0" max="80" value="'+ap.bgDark+'"><span class="hp-slider-val" id="olBgDarkVal">'+ap.bgDark+'%</span></div><div class="hp-divider"></div><div class="hp-section-label">聊天设置</div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">字体选择</span><select id="olChatFont" class="ol-select-arrow" style="width:110px;height:42px;padding:0 30px 0 12px;box-sizing:border-box;border:none;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;-webkit-appearance:none;appearance:none;box-shadow:0 1px 4px rgba(0,0,0,0.05);"></select></div><div class="ol-sw-row" style="margin-bottom:12px;">人称称呼 '+sw('olPovOn',ap.povOn)+'</div><div id="olPovSub" style="'+(ap.povOn?'':'display:none;')+'"><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼用户</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povu-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povu-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povu-btn" data-pov="third">第三人称</button></div></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼角色</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povc-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povc-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povc-btn" data-pov="third">第三人称</button></div></div></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">期望字数</span><input type="number" id="olWordCount" placeholder="留空不限" value="'+(ap.wordCount||'')+'" style="flex:1;min-width:0;height:42px;padding:0 12px;box-sizing:border-box;border:none;border-radius:8px;font-size:14px;box-shadow:0 1px 4px rgba(0,0,0,0.05);"></div><div class="hp-divider"></div><div class="hp-section-label">外观</div>' +
'<div class="ol-color-grid" style="grid-template-columns:repeat(3,1fr);margin-bottom:12px;"><div class="ol-color-item"><div class="hp-color-dot" id="olPageBg"></div><span>页面背景</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olCardBg"></div><span>顶部卡片</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olCardTextColor"></div><span>卡片文字</span></div></div>' +
...
'<div style="display:flex;gap:8px;margin-bottom:8px;"><input type="text" id="olCardT1" class="pc-edit-input" placeholder="卡片1文字" value="'+App.escAttr(ap.cardT1)+'"><input type="text" id="olCardT2" class="pc-edit-input" placeholder="卡片2文字" value="'+App.escAttr(ap.cardT2)+'"></div><div style="display:flex;gap:8px;margin-bottom:12px;"><input type="text" id="olCardT3" class="pc-edit-input" placeholder="卡片3文字" value="'+App.escAttr(ap.cardT3)+'"><input type="text" id="olCardT4" class="pc-edit-input" placeholder="卡片4文字" value="'+App.escAttr(ap.cardT4)+'"></div>' +
...
'<div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olCardReset">恢复卡片默认</button></div>' +
'<div class="hp-divider" style="margin:16px 0;"></div>' +
'<div class="ol-color-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:12px;"><div class="ol-color-item"><div class="hp-color-dot" id="olBarBg"></div><span>底栏底色</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olBarBorderColor"></div><span>底栏边框</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olBarIconColor"></div><span>图标控件</span></div><div class="ol-color-item"><div class="hp-color-dot" id="olInputTextColor"></div><span>输入文字</span></div></div>' +
'<div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏粗细</span><input type="range" id="olBarBorderW" min="0" max="5" step="0.5" value="'+ap.barBorderW+'"><span class="hp-slider-val" id="olBarBorderWVal">'+ap.barBorderW+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏圆角</span><input type="range" id="olBarRadius" min="0" max="30" value="'+ap.barRadius+'"><span class="hp-slider-val" id="olBarRadiusVal">'+ap.barRadius+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">装饰文字</span><input type="text" id="olPlaceholderInput" class="pc-edit-input" value="'+App.escAttr(ap.placeholder||'宇宙带着星轨在私奔✮ ࣪ ⊹⋆˚')+'" style="flex:1;height:42px;padding:0 12px;box-sizing:border-box;border:none;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;box-shadow:0 1px 4px rgba(0,0,0,0.05);"></div><div class="hp-btn-row"><button class="hp-btn hp-btn-outline" id="olSbBarBgBtn">底栏图填充</button><button class="hp-btn hp-btn-danger" id="olSbBarBgDel">清除底栏图</button></div><input type="file" id="olBarBgInput" accept="image/*" hidden><div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olBarReset">恢复底栏默认</button></div><div class="hp-divider"></div><div class="hp-btn-row"><button class="hp-btn ol-mode-btn" data-mode="bubble">气泡模式</button><button class="hp-btn ol-mode-btn" data-mode="parallel">全屏沉浸</button></div><div class="hp-divider"></div><div class="ol-sub-title">角色板块</div>'+fold('olFCav','角色头像',cAv)+fold('olFCbub','角色气泡',cBub)+fold('olFCfont','角色字体',cFont)+'<div class="hp-divider"></div><div class="ol-sub-title">用户板块</div>'+fold('olFUav','用户头像',uAv)+fold('olFUbub','用户气泡',uBub)+fold('olFUfont','用户字体',uFont)+'<div class="hp-divider"></div><div class="hp-section-label">高级</div><div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olStyleReset" style="padding:14px 0;">恢复全部默认</button><button class="hp-btn hp-btn-outline" id="olSbCode" style="padding:14px 0;">自定义UI</button></div><div class="hp-bottom-spacer"></div></div></div></div>';
