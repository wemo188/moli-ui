...
h+='<div class="ol-inline-row"><span>颜色</span><div class="hp-color-dot" id="ol'+p+'Color" data-fk="'+p+'Color"></div></div><div class="hp-slider-row"><span class="hp-slider-label">字号</span><input type="range" data-fk="'+p+'Size" min="10" max="40" step="0.5" value="'+ap[p+'Size']+'"><span class="hp-slider-val" id="ol'+p+'SizeVal">'+ap[p+'Size']+'px</span></div><div class="hp-slider-row"><span class="hp-slider-label">字重</span><input type="range" data-fk="'+p+'Weight" min="100" max="900" step="100" value="'+ap[p+'Weight']+'"><span class="hp-slider-val" id="ol'+p+'WeightVal">'+ap[p+'Weight']+'</span></div><div class="ol-inline-tag-row"><span class="ol-sub-label">样式</span><div class="ol-tag-group">'+tg('ol-'+p+'-style','normal','正常',!ap[p+'Italic'])+tg('ol-'+p+'-style','italic','斜体',ap[p+'Italic'])+'</div></div>';return h;}
