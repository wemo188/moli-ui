...
'.mm-ec-1{left:2px;bottom:20px;transform:rotate(-10deg);z-index:1;} .mm-ec-2{left:105px;bottom:10px;transform:rotate(10deg);z-index:2;} .mm-ec-3{left:205px;bottom:20px;transform:rotate(5deg);z-index:3;} .mm-ec-4{left:308px;bottom:15px;transform:rotate(-14deg);z-index:4;} ' +
...
'.ol-top-bg{position:absolute;top:0;left:0;right:0;height:75px;z-index:4;background-color:var(--ol-top-bg-color);background-image:var(--ol-top-bg-img);background-size:cover;background-position:center;pointer-events:none;} ' +
'.ol-msgs{position:relative;z-index:3;flex:1;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;margin-top:75px !important;margin-bottom:106px !important;padding:10px 16px 20px !important;min-height:0;overscroll-behavior:contain;scrollbar-width:none;} ' +
'.ol-msgs::-webkit-scrollbar{display:none;} ' +
'.ol-msg-actions{display:flex;gap:16px;margin-top:6px;padding:0 8px;opacity:0.6;transition:opacity 0.2s;} .ol-block:hover .ol-msg-actions{opacity:1;} .ol-block.is-user .ol-msg-actions{justify-content:flex-end;} ' +
'.ol-action-btn{font-size:11px;color:var(--ol-meta-color);display:flex;align-items:center;gap:3px;cursor:pointer;-webkit-tap-highlight-color:transparent;} .ol-action-btn svg{width:13px;height:13px;stroke:currentColor;fill:none;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;} ' +
'.ol-scroll-nav{position:fixed;right:8px;bottom:120px;z-index:100;display:flex;flex-direction:column;gap:12px;opacity:1;transition:opacity 0.3s;pointer-events:auto;} ' +
'.ol-scroll-nav.hidden{opacity:0;pointer-events:none;} ' +
'.ol-nav-btn{width:32px;height:32px;border-radius:50%;background:rgba(255,255,255,0.35);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);border:1px solid rgba(255,255,255,0.4);display:flex;align-items:center;justify-content:center;color:#7ea3c9;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.05);-webkit-tap-highlight-color:transparent;} ' +
'.ol-nav-btn:active{background:rgba(255,255,255,0.6);} ' +
