...
var chatHtml = '<div class="hp-btn-row" style="margin-bottom:12px;"><button class="hp-btn hp-btn-outline" id="olSbScene" style="width:100%;border-color:#adcdea;"><svg viewBox="0 0 24 24" style="width:16px;height:16px;margin-right:6px;vertical-align:-3px;fill:none;stroke:currentColor;stroke-width:2;"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>编辑场景/时间线</button></div><div class="ol-sw-row" style="margin-bottom:12px;">人称称呼 '+sw('olPovOn',ap.povOn)+'</div><div id="olPovSub" style="'+(ap.povOn?'':'display:none;')+'"><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼用户</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povu-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povu-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povu-btn" data-pov="third">第三人称</button></div></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">称呼角色</span><div style="display:flex;gap:12px;flex:1;"><button class="hp-btn ol-povc-btn" data-pov="first">第一人称</button><button class="hp-btn ol-povc-btn" data-pov="second">第二人称</button><button class="hp-btn ol-povc-btn" data-pov="third">第三人称</button></div></div></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">期望字数</span><input type="number" id="olWordCount" placeholder="留空不限" value="'+(ap.wordCount||'')+'" style="flex:1;min-width:0;height:42px;padding:0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;box-shadow:0 1px 4px rgba(0,0,0,0.05);outline:none;"></div>';

var appHtml = '<div class="ol-sub-title" style="margin-top:0;">整体</div><div class="ol-color-grid" style="grid-template-columns:repeat(1,1fr);margin-bottom:12px;"><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;width:100%;"><span>页面背景</span><div class="hp-color-dot" id="olPageBg"></div></div></div><div class="hp-btn-row" style="margin-bottom:12px;"><button class="hp-btn hp-btn-outline" id="olSbBg" style="width:100%;border-color:#adcdea;">上传背景</button></div><div class="hp-slider-row"><span class="hp-slider-label">白色遮罩</span><input type="range" id="olBgBlur" min="0" max="100" value="'+ap.bgBlur+'"><span class="hp-slider-val" id="olBgBlurVal">'+ap.bgBlur+'%</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label">明度视觉</span><input type="range" id="olBgDark" min="0" max="80" value="'+ap.bgDark+'"><span class="hp-slider-val" id="olBgDarkVal">'+ap.bgDark+'%</span></div><div class="hp-slider-row" style="margin-bottom:18px;"><span class="hp-slider-label" style="width:60px">字体选择</span><select id="olChatFont" class="ol-select-arrow" style="width:110px;height:42px;padding:0 30px 0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;-webkit-appearance:none;appearance:none;"></select></div><div class="hp-btn-row" style="margin-bottom:12px;"><button class="hp-btn ol-mode-btn" data-mode="bubble">气泡模式</button><button class="hp-btn ol-mode-btn" data-mode="parallel">全屏沉浸</button></div><div class="hp-divider"></div><div class="ol-sub-title">顶部区域</div><div class="ol-color-grid" style="grid-template-columns:repeat(2,1fr);margin-bottom:12px;"><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>卡片颜色</span><div class="hp-color-dot" id="olCardBg"></div></div><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>卡片文字</span><div class="hp-color-dot" id="olCardTextColor"></div></div></div><div style="display:flex;gap:8px;margin-bottom:12px;"><button class="hp-btn hp-btn-outline" id="olBtnUp1">传图1</button><button class="hp-btn hp-btn-outline" id="olBtnUp2">传图2</button><button class="hp-btn hp-btn-outline" id="olBtnUp3">传图3</button><button class="hp-btn hp-btn-outline" id="olBtnUp4">传图4</button></div><input type="file" id="olCardUpInput" accept="image/*" hidden><div style="display:flex;gap:8px;margin-bottom:8px;"><input type="text" id="olCardT1" class="pc-edit-input" placeholder="银河歌颂" value="'+App.escAttr(ap.cardT1||'银河歌颂')+'" style="border:1.5px solid #adcdea;border-radius:8px;"><input type="text" id="olCardT2" class="pc-edit-input" placeholder="梦想在冒险" value="'+App.escAttr(ap.cardT2||'梦想在冒险')+'" style="border:1.5px solid #adcdea;border-radius:8px;"></div><div style="display:flex;gap:8px;margin-bottom:12px;"><input type="text" id="olCardT3" class="pc-edit-input" placeholder="星星怀抱月夜" value="'+App.escAttr(ap.cardT3||'星星怀抱月夜')+'" style="border:1.5px solid #adcdea;border-radius:8px;"><input type="text" id="olCardT4" class="pc-edit-input" placeholder="明天想见你" value="'+App.escAttr(ap.cardT4||'明天想见你')+'" style="border:1.5px solid #adcdea;border-radius:8px;"></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">卡片字体</span><select id="olCardFont" class="ol-select-arrow" style="width:110px;height:42px;padding:0 30px 0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;-webkit-appearance:none;appearance:none;"></select></div><div class="hp-btn-row"><button class="hp-btn hp-btn-danger" id="olCardReset">恢复默认(顶部)</button></div><div class="hp-divider"></div><div class="ol-sub-title">底部区域</div><div class="ol-color-grid" style="grid-template-columns:repeat(2,1fr);margin-bottom:12px;"><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>底栏底色</span><div class="hp-color-dot" id="olBarBg"></div></div><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>底栏边框</span><div class="hp-color-dot" id="olBarBorderColor"></div></div><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>图标控件</span><div class="hp-color-dot" id="olBarIconColor"></div></div><div class="ol-color-item" style="flex-direction:row;justify-content:space-between;"><span>输入文字</span><div class="hp-color-dot" id="olInputTextColor"></div></div></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏粗细</span><input type="range" id="olBarBorderW" min="0" max="5" step="0.5" value="'+ap.barBorderW+'"><span class="hp-slider-val" id="olBarBorderWVal">'+ap.barBorderW+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">底栏圆角</span><input type="range" id="olBarRadius" min="0" max="30" value="'+ap.barRadius+'"><span class="hp-slider-val" id="olBarRadiusVal">'+ap.barRadius+'px</span></div><div class="hp-slider-row" style="margin-bottom:12px;"><span class="hp-slider-label" style="width:60px">装饰文字</span><input type="text" id="olPlaceholderInput" class="pc-edit-input" value="'+App.escAttr(ap.placeholder||'宇宙带着星轨在私奔✮ ࣪ ⊹⋆˚')+'" style="flex:1;height:42px;padding:0 12px;box-sizing:border-box;border:1.5px solid #adcdea;border-radius:8px;font-size:14px;color:#1a1a1a;background-color:#fff;outline:none;font-family:inherit;"></div><div class="hp-btn-row"><button class="hp-btn hp-btn-outline" id="olSbBarBgBtn">底栏图填充</button><button class="hp-btn hp-btn-danger" id="olSbBarBgDel">清除底栏图</button></div><div class="hp-btn-row" style="margin-top:8px;"><button class="hp-btn hp-btn-danger" id="olBarReset">恢复默认(底部)</button></div>';
...
fold('olFChatSettings', '聊天设置', chatHtml) +
fold('olFAppearance', '外观', appHtml) +
fold('olFCav', '角色板块', cAv+cBub+cFont) +
fold('olFUav', '用户板块', uAv+uBub+uFont) +
'<div class="hp-divider"></div>' +
'<div class="hp-btn-row" style="margin-bottom:12px;"><button class="hp-btn hp-btn-primary" id="olSaveTheme" style="width:100%;">存储为新主题</button></div>' +
'<div class="hp-btn-row" style="margin-bottom:12px;"><button class="hp-btn hp-btn-danger" id="olStyleReset" style="width:100%;">恢复全部默认</button></div>' +
'<div class="hp-btn-row" style="margin-bottom:20px;"><button class="hp-btn hp-btn-outline" id="olSbCode" style="width:100%;border-color:#adcdea;">自定义UI</button></div>' +
...
App.safeOn('#olSaveTheme','click',function(){
  App.showToast('主题已存储');
});
...
var mc=App.$('#olMsgs');
if(mc){var lt=null,lT=null,mv=false;mc.addEventListener('touchstart',function(e){var txt=e.target.closest('.ol-bubble-text');if(txt){txt.classList.add('ol-selecting');return;}var b=e.target.closest('.ol-block');if(!b)return;mv=false;var t=e.touches[0];lT={el:b,x:t.clientX,y:t.clientY};lt=setTimeout(function(){if(lT&&!mv){if(navigator.vibrate)navigator.vibrate(15);O.showCtxMenu(lT.el,lT.x,lT.y);}},500);},{passive:true});mc.addEventListener('touchmove',function(e){if(lt){var t=e.touches[0];if(lT&&(Math.abs(t.clientX-lT.x)>8||Math.abs(t.clientY-lT.y)>8)){mv=true;clearTimeout(lt);lT=null;}}},{passive:true});mc.addEventListener('touchend',function(){clearTimeout(lt);lT=null;setTimeout(function(){mc.querySelectorAll('.ol-selecting').forEach(function(el){el.classList.remove('ol-selecting');});},300);},{passive:true});}
